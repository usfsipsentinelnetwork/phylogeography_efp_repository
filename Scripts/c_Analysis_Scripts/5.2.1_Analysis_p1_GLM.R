...
aov06 <- 
  rbind(
    ...
    anova(model_5_centered,model_6_centered)[2,c('Chisq','Df','Pr(>Chisq)')],
    anova(model_5_centered,model_final_zinf_centered)[2,c('Chisq','Df','Pr(>Chisq)')])
...
save.image("Final_output/linearmodels.RData")
